...
$ResourceGroupName = $Name  # Resource group everything will be created in
$Location = "East US"         # Physical location of all the resources
$KeyVaultName = $Name     # name of the Key Vault
